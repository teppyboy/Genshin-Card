...
function range(start, end) {
    ...
    return Array.from(new Array(parseInt(end) + 1).keys()).slice(
        parseInt(start)
    )
}
...
async function svg({ data, skin = 0, detail = false }) {
    // '2,5,9' -> [2, 5, 9]
    // '3-5' -> [3, 4, 5]
    ...
    const tpl = `<?xml version="1.0" encoding="UTF-8"?>
      <svg id="gi-card" width="500" height="165" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
